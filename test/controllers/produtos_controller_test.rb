...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { codigo_barra: @produto.codigo_barra, nome: @produto.nome, preco: @produto.preco } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { codigo_barra: @produto.codigo_barra, nome: @produto.nome, preco: @produto.preco } }
