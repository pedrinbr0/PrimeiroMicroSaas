...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference("Compra.count") do
      post compras_url, params: { compra: { cliente_id: @compra.cliente_id, data: @compra.data, descricao: @compra.descricao, valor: @compra.valor } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { cliente_id: @compra.cliente_id, data: @compra.data, descricao: @compra.descricao, valor: @compra.valor } }
